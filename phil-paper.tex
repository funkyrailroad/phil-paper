...
aid, the most obvious source of ideas is the field of foreign aid. However it
is very possible (and in cases has already been shown to be true) that some of
these measures do not benefit people with disabilties as much as people
without disabilties. A shared goal of inclusive foreign aid and foreign aid is
poverty reduction, so it may at least be conjectured that similar efforts may
also help reduce poverty among disabled populations. This at least serves as a
good starting point because although it may benefit people with disabilties
less, it still does benefit them. A solution that was first implemented in the
field of foreign aid but can also potentially benefit populations of people
with disabilities is providing microfinance opportunties.
...
concerned with whether or not a given policy has the intened effects.
...
multidimensional phenemenon that involve variables other than merely income
...
helpful also for people with disabiities, but ample data has not been
collected to either refute or confirm these claims.

There are two ways that this type of data may be obtained and interpereted:
the micro and macro perspectives \citep{ingstad2011disability}. Here is also
the contrast between the pure abstractions of the ``universal'' and the
``particular,'' as well as the hybrid ``individual'' as used by
\cite{collingwood1922history}. The micro perspective focuses on individual
rerspectives and stories; the specific incidences and consequences of living
...
description, either disabled or not, there are clearly different type of
