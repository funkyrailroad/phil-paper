...
Kuhn argued that the two contexts are not fundamental aspects of the knowledge
generation process. In his view, the discovery and justification processes are
not elementary components of logic and epistemology, but rather essential
...
intertwined with the current state of the theory. He explains this based on
the example of oxygen. There were multiple people who could be considered
candidates for the discovery of oxygen by isolating it to some extent. They
may have known that they had produced and isolated something different, but
they did not necessarily know what it was that oxygen that they had isolated.
The point where discovery and theory become intertwined are by realizing that
it is us modern folk who are designating those gentlemen as the discoverers of
oxygen, and we are defining oxygen as we currently understand it, which could
conceivably be incorrect.

One can also see how the discovery/justification distinction is also not of a
fundamental methodological nature. To see this, one just needs to find a
method that can be used both for discovery and justification. Participatory
research is an example of such a method.

A similar situation arises in the justification process. In justifying the
theory, one uses elements of the theory to justify it. In the example of
...
definition. As the notion of poverty evolved and the its multi-dimensional
nature become to be appreciated, certain knowledge claims that were justified
with respect to the simplistic definition were no longer justified with
respect to the multi-dimensional definition. Nothing in the logic of the
justification process changed, but rather something prior to the logic: one of
the premises and definitions upon which the logical argumentation was based.
So the context of justification surely involves logical processes, but it also
